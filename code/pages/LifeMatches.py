...
life_df[['radiant_team.team_id', 'dire_team.team_name']] = life_df[['radiant_team.team_id', 'dire_team.team_name']].astype('int64')

st.dataframe(life_df[['match_id', 'radiant_team.team_name', 'dire_team.team_name']])
